...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "UsageLog" ADD CONSTRAINT "UsageLog_userId_User_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "DocumentChunk" ADD CONSTRAINT "DocumentChunk_knowledgeSourceId_KnowledgeSource_id_fk" FOREIGN KEY ("knowledgeSourceId") REFERENCES "public"."KnowledgeSource"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
